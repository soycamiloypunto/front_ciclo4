                ...
                <div className="card" id="card-login">
                    <div className="card-body">
                        <div className="text-center">
                            <h4 className="card-title mb-2 mt-1">Login in</h4>
                            <hr />
                            <img alt="" src={img} id="img-login" />
                            {!(validateEmail(email)) ?
                                <p className="text-danger mt-2">Email Invalid</p> : null}
                        </div>
                        <form className="mt-4" onSubmit={handleSubmit}>
                            ...
                            <div className="text-center">
                                <Button type="submit" variant="primary" disabled={!validateForm(email, password)}>Login</Button>
                            </div>
                        </form>
                    </div>
                </div>
